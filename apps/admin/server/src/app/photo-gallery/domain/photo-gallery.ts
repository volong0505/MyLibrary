...
export type PhotoGalleryProperties = PhotoGalleryEssentialProperties &
  Required<PhotoGalleryOptionalProperties>;
...
export class PhotoGalleryImplement
  extends AggregateRoot
  implements PhotoGallery
{
